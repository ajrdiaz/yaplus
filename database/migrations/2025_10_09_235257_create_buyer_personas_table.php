...
return new class extends Migration
{
    ...
    {
        Schema::create('form_buyer_personas', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('total_responses_analyzed')->default(0); // Metadatos
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('form_buyer_personas');
    }
};
