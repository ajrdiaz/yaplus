...
<template>
    ...
    <Sidebar v-model:visible="layoutState.configSidebarVisible.value" position="right"
        class="layout-config-sidebar w-20rem" :pt="{
            closeButton: 'ml-auto'
        }">
        <h5>Themes</h5>
        ...
        <template v-if="!simple">
            ...
            <div class="flex flex-wrap row-gap-3">
                ...
                <div class="flex align-items-center gap-2 w-6">
                    <RadioButton name="menuMode" value="reveal" v-model="layoutConfig.menuMode.value" inputId="mode5">
                    </RadioButton>
                    <label for="mode4">Reveal</label>
                </div>
                <div class="flex align-items-center gap-2 w-6">
                    <RadioButton name="menuMode" value="drawer" v-model="layoutConfig.menuMode.value" inputId="mode6">
                    </RadioButton>
            ...
            <div class="field-radiobutton">
                <RadioButton :checked="layoutConfig.menuTheme === 'colorScheme'" name="menuTheme" value="colorScheme"
                    v-model="layoutConfig.menuTheme.value" inputId="mode1"></RadioButton>
                <label for="mode1">Color Scheme</label>
            </div>

            <div class="field-radiobutton">
                <RadioButton :checked="layoutConfig.menuTheme === 'primaryColor'" name="menuTheme" value="primaryColor"
                    v-model="layoutConfig.menuTheme.value" inputId="mode2"></RadioButton>
                <label for="mode2">Primary Color</label>
            </div>
            <div class="field-radiobutton">
                <RadioButton :checked="layoutConfig.menuTheme === 'transparent'" name="menuTheme" value="transparent"
                    v-model="layoutConfig.menuTheme.value" inputId="mode3"></RadioButton>
        ...
        <div class="field-radiobutton flex-1">
            <RadioButton v-model="colorScheme" name="colorScheme" value="light"
                @change="() => changeColorScheme('light')" inputId="outlined_input"></RadioButton>
            <label for="outlined_input">Light</label>
        </div>
        <div class="field-radiobutton flex-1">
            <RadioButton v-model="colorScheme" name="colorScheme" value="dim" @change="() => changeColorScheme('dim')"
                inputId="filled_input"></RadioButton>
            <label for="filled_input">Dim</label>
        </div>
        <div class="field-radiobutton flex-1">
            <RadioButton v-model="colorScheme" name="colorScheme" value="dark" @change="() => changeColorScheme('dark')"
                inputId="filled_input"></RadioButton>
